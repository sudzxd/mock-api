...
from ...core.protocols import IDataGenerator
...
class DataGenerator(IDataGenerator):
    ...
    Implements IDataGenerator protocol for dependency injection and extensibility.
    ...
    def generate(
        self,
        model_name: str,
        count: int = DEFAULT_GENERATION_COUNT,
        ...
        Args:
            ...
            exclude_fks: If True, exclude foreign key generation.
        ...
        Example:
            ...
            True
        """
        # TODO: Implement exclude_fks parameter for FK exclusion (future work)
        _ = exclude_fks  # Protocol compatibility - not yet implemented
    ...
    def generate_all(
        self, count: int = DEFAULT_GENERATION_COUNT
        ...
        Example:
            >>> all_data = generator.generate_all(count=5)
            >>> "User" in all_data
            True
            >>> "Post" in all_data
            True
        ...
        for model_name in generation_order:
            result[model_name] = self.generate(model_name, count=count)
